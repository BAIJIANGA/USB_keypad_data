...
#define ACC_SCALE_FACTOR ACC_Range_2g
#define GYRO_SCALE_FACTOR GYRO_Range_500dps

#define ACC_LIMIT(X) X=(X>1?1:(X<-1?-1:X))

#define ACC_Range_2g 0.00006103515625f
#define ACC_Range_4g 0.0001220703125f
#define ACC_Range_8g 0.000244140625f
#define ACC_Range_16g 0.00048828125f

#define GYRO_Range_245dps 0.007476806640625f
#define GYRO_Range_500dps 0.0152587890625f
#define GYRO_Range_1000dps 0.030517578125f
#define GYRO_Range_2000dps 0.06103515625f

typedef struct 
{
    short* ACC_Data;//加速度原始数据
    short* GYRO_Data;//陀螺仪原始数据
    float* ACC_x_y_z;//三轴加速度
    float* GYRO_p_r_y;//陀螺仪三轴角速度
	float* GYRO_Zero_Shift;//陀螺仪零飘数据
}LSM6DS3_DateTypeDef;
